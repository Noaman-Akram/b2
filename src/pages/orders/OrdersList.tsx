            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <div className="space-y-1 text-sm">
                  ...
                  <p><span className="text-gray-600">Cost:</span> {order.order_cost.toLocaleString()} EGP</p>
                  <p><span className="text-gray-600">Profit:</span> {(order.order_price - order.order_cost).toLocaleString()} EGP</p>
                </div>
              </div>
            </div>
